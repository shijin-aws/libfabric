...
uint32_t efa_mock_efa_ibv_cq_read_opcode_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}

uint32_t efa_mock_efa_ibv_cq_read_vendor_err_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}

uint32_t efa_mock_efa_ibv_cq_read_qp_num_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}

uint32_t efa_mock_efa_ibv_cq_read_wc_flags_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}

uint32_t efa_mock_efa_ibv_cq_read_imm_data_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}
...
enum ibv_wc_opcode __wrap_efa_ibv_cq_read_opcode(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_opcode(ibv_cq);
}
...
uint32_t __wrap_efa_ibv_cq_read_qp_num(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_qp_num(ibv_cq);
}

uint32_t __wrap_efa_ibv_cq_read_vendor_err(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_vendor_err(ibv_cq);
}

uint32_t __wrap_efa_ibv_cq_read_src_qp(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_src_qp(ibv_cq);
}

uint32_t __wrap_efa_ibv_cq_read_slid(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_slid(ibv_cq);
}

uint32_t __wrap_efa_ibv_cq_read_byte_len(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_byte_len(ibv_cq);
}

unsigned int __wrap_efa_ibv_cq_read_wc_flags(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_wc_flags(ibv_cq);
}

__be32 __wrap_efa_ibv_cq_read_imm_data(struct efa_ibv_cq *ibv_cq)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_imm_data(ibv_cq);
}
...
int __wrap_efa_ibv_cq_read_sgid(struct efa_ibv_cq *ibv_cq, union ibv_gid *sgid)
{
	return g_efa_unit_test_mocks.efa_ibv_cq_read_sgid(ibv_cq, sgid);
}
...
uint32_t efa_mock_efa_ibv_cq_read_src_qp_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}

uint32_t efa_mock_efa_ibv_cq_read_byte_len_return_mock(struct efa_ibv_cq *current)
{
	return mock();
};

uint32_t efa_mock_efa_ibv_cq_read_slid_return_mock(struct efa_ibv_cq *current)
{
	return mock();
}
