...
void test_impl_cq_read_empty_cq(struct efa_resource *resource, enum fi_ep_type ep_type)
{
	...
	orig_start_poll = ibv_cqx->start_poll;
	...
	ibv_cqx->start_poll = orig_start_poll;
}
...
void test_ibv_cq_ex_read_bad_recv_status(struct efa_resource **state)
{
	...
	orig_start_poll = efa_rdm_cq->ibv_cq.ibv_cq_ex->start_poll;
	...
	efa_rdm_cq->ibv_cq.ibv_cq_ex->start_poll = orig_start_poll;
}
