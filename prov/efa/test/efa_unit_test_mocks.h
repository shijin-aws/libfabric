...
uint32_t efa_mock_efa_ibv_cq_read_wc_flags_return_mock(struct efa_ibv_cq *ibv_cq);
...
enum ibv_wc_opcode __real_efa_ibv_cq_read_opcode(struct efa_ibv_cq *ibv_cq);
void __real_efa_ibv_cq_end_poll(struct efa_ibv_cq *ibv_cq);
uint32_t __real_efa_ibv_cq_read_qp_num(struct efa_ibv_cq *ibv_cq);
uint32_t __real_efa_ibv_cq_read_vendor_err(struct efa_ibv_cq *ibv_cq);
uint32_t __real_efa_ibv_cq_read_src_qp(struct efa_ibv_cq *ibv_cq);
uint32_t __real_efa_ibv_cq_read_slid(struct efa_ibv_cq *ibv_cq);
uint32_t __real_efa_ibv_cq_read_byte_len(struct efa_ibv_cq *ibv_cq);
unsigned int __real_efa_ibv_cq_read_wc_flags(struct efa_ibv_cq *ibv_cq);
__be32 __real_efa_ibv_cq_read_imm_data(struct efa_ibv_cq *ibv_cq);
bool __real_efa_ibv_cq_wc_is_unsolicited(struct efa_ibv_cq *ibv_cq);
int __real_efa_ibv_cq_read_sgid(struct efa_ibv_cq *ibv_cq, union ibv_gid *sgid);
...
struct efa_unit_test_mocks
{
	...
	enum ibv_wc_opcode (*efa_ibv_cq_read_opcode)(struct efa_ibv_cq *ibv_cq);
	void (*efa_ibv_cq_end_poll)(struct efa_ibv_cq *ibv_cq);
	uint32_t (*efa_ibv_cq_read_qp_num)(struct efa_ibv_cq *ibv_cq);
	uint32_t (*efa_ibv_cq_read_vendor_err)(struct efa_ibv_cq *ibv_cq);
	uint32_t (*efa_ibv_cq_read_src_qp)(struct efa_ibv_cq *ibv_cq);
	uint32_t (*efa_ibv_cq_read_slid)(struct efa_ibv_cq *ibv_cq);
	uint32_t (*efa_ibv_cq_read_byte_len)(struct efa_ibv_cq *ibv_cq);
	unsigned int (*efa_ibv_cq_read_wc_flags)(struct efa_ibv_cq *ibv_cq);
	__be32 (*efa_ibv_cq_read_imm_data)(struct efa_ibv_cq *ibv_cq);
	bool (*efa_ibv_cq_wc_is_unsolicited)(struct efa_ibv_cq *ibv_cq);

	int (*efa_ibv_cq_read_sgid)(struct efa_ibv_cq *ibv_cq, union ibv_gid *sgid);
