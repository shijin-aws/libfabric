...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_direct_mr_reg_fi_read_support_status, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_direct_mr_reg_fi_write_support_status, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
