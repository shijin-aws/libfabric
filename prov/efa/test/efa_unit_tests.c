...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_ibv_post_write_high_pps_calls_processing_hint, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_ibv_post_write_high_pps_not_called_when_disabled, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_data_path_direct_write_high_pps_hint_not_set_when_disabled, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
