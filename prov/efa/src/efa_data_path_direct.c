...
int efa_data_path_direct_qp_initialize(struct efa_qp *efa_qp)
{
	...
	efa_data_path_timer_init(&efa_qp->data_path_direct_qp.send_timing);
	efa_data_path_timer_init(&efa_qp->data_path_direct_qp.recv_timing);
	...
	efa_qp->data_path_direct_enabled = 1;
	return ret;
}
...
int efa_data_path_direct_cq_initialize(struct efa_cq *efa_cq)
{
	...
	efa_data_path_timer_init(&data_path_direct->timing);
	...
	efa_cq->ibv_cq.data_path_direct_enabled = 1;
