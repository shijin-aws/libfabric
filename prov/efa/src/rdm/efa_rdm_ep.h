 ...
 */
static inline
int efa_rdm_ep_use_p2p(struct efa_rdm_ep *efa_rdm_ep, struct efa_rdm_mr *efa_rdm_mr)
{
	/*
	 ...
	 */
	if (!efa_rdm_mr || efa_rdm_mr->peer.iface == FI_HMEM_SYSTEM)
		return 1;

	if (g_efa_hmem_info[efa_rdm_mr->peer.iface].p2p_supported_by_device)
