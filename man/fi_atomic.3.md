...
int fi_xpu_atomic(void *ep, const void *buf, size_t count, void *desc,
    void *dest_addr, uint64_t addr, uint64_t key,
    int datatype, int op, void *context,
    uint64_t flags, int scope);

int fi_xpu_fetch_atomic(void *ep, const void *buf, size_t count, void *desc,
    void *result, void *result_desc,
    void *dest_addr, uint64_t addr, uint64_t key,
    int datatype, int op, void *context,
    uint64_t flags, int scope);

int fi_xpu_compare_atomic(void *ep, const void *buf, size_t count, void *desc,
